...
InvalidExtensionError::InvalidExtensionError(const char* _what): FSystemError(_what) {}

InvalidFileError::InvalidFileError(const char* _what): FSystemError(_what) {}

EmptyPathError::EmptyPathError(): FSystemError("Cannot get the last component of an empty path!") {}
