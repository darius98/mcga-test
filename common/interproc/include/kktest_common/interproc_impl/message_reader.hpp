#ifndef KKTEST_COMMON_INTERPROC_IMPL_MESSAGE_READER_HPP_
#define KKTEST_COMMON_INTERPROC_IMPL_MESSAGE_READER_HPP_
...
class MessageReader {
 public:
    ...
    MessageReader& operator<<(T& obj) {
        obj = *static_cast<T*>(
                static_cast<void*>(
                  static_cast<std::uint8_t*>(message.payload) + cursor));
        cursor += sizeof(obj);
        return *this;
    }
