...
check_warning(
    "Exception thrown in group \"group\": exception-in-group. Unable to execute remainder of tests in this group.")
check_warning(
    "Non-exception thrown in group \"group2\". Unable to execute remainder of tests in this group.")
